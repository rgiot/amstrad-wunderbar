...
;exo_mapbasebitsdefs    156             ;tables for bits, baseL, baseH
...
exo_initbits   ld      c, 16
                ...
                ld      ixl, c
                ld      de, 1           ;DE=b2
exo_get4bits   ;call exo_getbit ; optimisation
    srl a
...
exo_getbits    dec     b
                ret     z
exo_getbits1   ;call exo_getbit ; optimisation
    srl a
    call z, exo_getbit
                rl      e
                rl      d
...
exo_literalcopy
                ldir
exo_mainloop   inc     c
                ;call exo_getbit ; optimisation
    srl a
    call z, exo_getbit     ;literal?
                jr      c, exo_literalcopy
                ld      c, 239
exo_getindex   ;call exo_getbit ; optimisation
    srl a
    call z, exo_getbit
                inc     c
                jr      nc,exo_getindex
