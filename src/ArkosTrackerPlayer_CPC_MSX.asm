PLY_ENABLE_STOP equ 0
PLY_ENABLE_JUMP equ 0
PLY_ENABLE_DIGIDRUMS equ 0
PLY_ENABLE_SPECIAL_TRACK equ 0
...
;   BC = Inverted Pitch (-0xFFFF -> FFFF). 0 is no pitch. The higher the pitch, the lower the sound.
;   call PLY_SFX_Play
...
PLY_UseFirmwareInterruptions equ 0 ;Set to 1 to use a Player under interruption. Only works on CPC, as it uses the CPC Firmware.
                ...
                ;SECOND WARNING, make sure the player is above 0x3fff, else it won't be played (system limitation).
...
PLY_RetrigValue equ 0xfe     ;Value used to trigger the Retrig of Register 13. 0xFE corresponds to CP xx. Do not change it !
...
PLY_SendRegisters
    ld (PLY_SendRegisters_Real.a), a
    ret

PLY_SendRegisters_Real
.a equ $+1
    ld a, 0
;A=Register 7
